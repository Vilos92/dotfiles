...
show_service_urls() {
    ...
    echo ""
    echo "🏠 GregZone Homepage (Tailscale):"
    echo "  • http://greg-zone"
    echo ""
    echo "📱 Local Access:"
    ...
    echo "  • Copyparty: https://copyparty.greglinscheid.com"
    echo "  • FreshRSS: https://freshrss.greglinscheid.com"
    echo "  • Kiwix: https://kiwix.greglinscheid.com"
    echo ""
    echo "🔒 Tailscale Access:"
    echo "  • Copyparty: http://greg-zone:9001"
    echo "  • FreshRSS: http://greg-zone:9002"
    echo "  • Kiwix: http://greg-zone:9003"
    echo ""
}
